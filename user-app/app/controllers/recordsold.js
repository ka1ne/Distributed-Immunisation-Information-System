...
exports.close = async function () {
        try {
                ...
                console.error(`******** FAILED to close the gateway: ${error}`);
        }
...
async function init (contract) {
        try {
                ...
                console.error(`******** FAILED to initialise the ledger: ${error}`);
        }
}
exports.init = init;
...
async function submitTx(record) {
        try {
...
exports.exists = async function (uuid) {
        console.log('\n--> Evaluate Transaction: AssetExists, function returns "true" if an asset with given UUID exist');
        result = await contract.evaluateTransaction('AssetExists', uuid);
        console.log(`*** Result: ${prettyJSONString(result.toString())}`);
}
